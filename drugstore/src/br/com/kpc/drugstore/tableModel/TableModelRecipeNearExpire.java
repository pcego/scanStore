 ...
 * @author www
 */
public class TableModelRecipeNearExpire extends AbstractTableModel {

    private List<Client> client;
    private String columns[] = new String[]{"CPF", "Nome", "Celular", "Endereço"};
    ...
    public TableModelRecipeNearExpire() {
        client = new ArrayList<>();

    }

    public TableModelRecipeNearExpire(List<Client> client) {
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case CELULAR:
                cli.setCellPhone_1((String) aValue);
            case ENDERECO:
